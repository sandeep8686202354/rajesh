...
convertDistrictDbObectToResponseObject = dbObject => {
  return {
...
app.get('/states/', authenticateToken, async (request, response) => {
  ...
  response.send(statesAray.map(i => convertStateDbObjectToResponseObject(i)))
})
...
app.get(
  ...
  WHERE 
   district_id = ${districtId};`
    ...
    response.send(convertDistrictDbObectToResponseObject(getDistrict))
  },
)
